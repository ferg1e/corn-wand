...
/**
 * Get a string that is a label tag and a select tag
 * containing option tags. You cannot set option tag
 * attributes using this function. However, the option
 * tag value attribute and selected value will be set
 * for you. This function will handle single select and
 * multi-select.
 *
 * @param string $label the content for the label
 *     tag. This value is not escaped.
 ...
 *     will be "l_$id" and the label 'for' will be
 *     $id. If this array contains the value
...
/**
 * Get a string that is a group of HTML radio buttons.
 * Each radio button renders using c\dlinput(), i.e.
 * each radio button is a div containing a label tag
 * and an input tag.
 *
 * @param string $name the value of the name attribute
 *      for all input tags is $name. The value of
 ...
 * @return string a group of HTML radio buttons.
 */
...
/**
 * Get a string that is a title span and a group of
 * HTML radio buttons. Each radio button renders using
 * c\dlinput(), i.e. each radio button is a div
 * containing a label tag and an input tag.
 *
 * @param string $title the content for the span tag.
 *     This value is not escaped.
 * @param string $name the value of the name attribute
